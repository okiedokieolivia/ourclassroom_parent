...
public class JwtUtils {
    ...
    public static String getJwtToken(JwtInfo jwtInfo, int expire){
        ...
        String JwtToken = Jwts.builder()
                ...
                .setSubject("ourclassroom-user")
                .setIssuedAt(new Date())
                .setExpiration(DateTime.now().plusSeconds(expire).toDate())//expire time
                .claim("id", jwtInfo.getId())//user id
                .claim("username", jwtInfo.getUsername())//username
                .claim("avatar", jwtInfo.getAvatar())//avatar
